...
const socialLinks = [
  { icon: IconFacebook, href: 'https://facebook.com/jibhaexpress', label: 'Facebook', color: 'hover:bg-blue-600' },
  { icon: IconInstagram, href: 'https://instagram.com/jibhaexpress', label: 'Instagram', color: 'hover:bg-pink-600' },
  { icon: IconLinkedin, href: 'https://linkedin.com/company/jibhaexpress', label: 'LinkedIn', color: 'hover:bg-sky-600' },
  { icon: IconXTwitter, href: 'https://x.com/jibhaexpress', label: 'X / Twitter', color: 'hover:bg-gray-700' },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs whitespace-pre-line">
              {t('tagline')}
            </p>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5">
              {services.map(({ label, href }) => (
                <li key={href}>
                  <Link href={href} className="text-sm text-gray-400 hover:text-blue-400 transition-colors duration-150 flex items-center gap-1.5 group">
          ...
          <div className="flex flex-col gap-5">
            <div>
              ...
              <ul className="flex flex-col gap-3">
                <li>
                  <a href="https://maps.google.com/?q=Lisbon+Portugal" target="_blank" rel="noopener noreferrer" className="flex items-start gap-2.5 text-sm text-gray-400 hover:text-blue-400 transition-colors duration-150 group">
                    <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0 group-hover:text-blue-400 text-gray-500" strokeWidth={1.75} />
                    <span>Rua Augusta 156,<br />1100-053 Lisbonne,<br />Portugal</span>
                  </a>
                </li>
                <li>
                  <a href="mailto:contact@jibhaexpress.com" className="flex items-center gap-2.5 text-sm text-gray-400 hover:text-blue-400 transition-colors duration-150 group">
                    <Mail className="w-4 h-4 flex-shrink-0 group-hover:text-blue-400 text-gray-500" strokeWidth={1.75} />
                    contact@jibhaexpress.com
                  </a>
                </li>
                <li>
                  <a href="tel:+351210000000" className="flex items-center gap-2.5 text-sm text-gray-400 hover:text-blue-400 transition-colors duration-150 group">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mb-3 leading-relaxed">{t('newsletterDesc')}</p>
              {subscribed ? (
        ...
        <div className="border-t border-white/10 pt-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500">
            <p>&copy; {new Date().getFullYear()} JibhaExpress. {t('rights')}.</p>
